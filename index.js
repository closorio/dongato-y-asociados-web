...
const resolvers = {
  Query: {
    hello: (_, { message }) => {
        return `¡Te has suscrito con el correo ${message} para recibir las últimas novedades y actualizaciones con éxito!`;
      },
  },
};
...
async function startApolloServer() {
  ...
  // Sirve la aplicación de React desde la carpeta "saludofront-app"
   const reactAppPath = path.join(__dirname, 'dongato-front-app', 'dist');
